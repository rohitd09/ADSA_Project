...
cell_font = pygame.font.SysFont(pygame.font.get_default_font(), 30) #font-size of text
...
def main_loop(ui):
	...
	bg = pygame.image.load("ADSA_path_finding/background.png")
	bg = pygame.transform.scale(bg,(1000,800)).convert_alpha(screen)
...
def draw_board(surface, area, board):
	...
	marks = {
		maze.CellMark.Start: (0,0,0), #start position
